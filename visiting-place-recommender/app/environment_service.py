...
class EnvironmentService(metaclass=SingletonMeta):
    ...
    def _setup_logfire(self) -> None:
        ...
        its model calls and tool calls) plus the outbound SerpApi HTTP requests, so each
        recommendation request reads as one labelled, drill-down-able trace.
        """
        import logfire
        ...
        logfire.configure(
            ...
            service_name="visiting-place-recommender",
